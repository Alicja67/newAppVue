...
#   curl --insecure -v -X GET https://sso.mac.pl:8008/auth/admin/realms/MAC-realm/events -H "Content-Type: application/json" -H "Authorization: bearer $TOKEN"
   ...
   echo "ID $ID"
    ...
    curl --insecure -v -X PUT https://sso.mac.pl:8008/auth/admin/realms/MAC-realm/users/$ID/groups/$SPECIALS -H "Content-Type: application/json" -H "Authorization: bearer $TOKEN"
    curl --insecure -v -X PUT https://sso.mac.pl:8008/auth/admin/realms/MAC-realm/users/$ID/groups/$SIEC_4_8 -H "Content-Type: application/json" -H "Authorization: bearer $TOKEN"
